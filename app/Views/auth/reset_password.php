...
<head>
    <meta charset="utf-8" />
    <title>Reset Password | Divine, Meesho Delivery Services</title>
        ...
        <div class="auth-page-content">
            ...
            <form action="<?= base_url('auth/updatePassword') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password_confirm" class="form-control" id="password_confirm" placeholder="Confirm your new password" required>
                </div>
            ...
            <div class="auth-footer mt-3">
                <a href="<?= base_url('auth/login'); ?>" class="text-muted">Back to Login</a>
            </div>
        </div>
    </div>
