            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?= base_url('public/assets/images/logo-light.png'); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
                        ...
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('public/assets/images/users/avatar-2.jpg'); ?>" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('public/assets/images/users/avatar-3.jpg'); ?>" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="<?= base_url('public/assets/images/users/avatar-5.jpg'); ?>" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-grow-1">
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="<?= base_url('public/assets/images/users/avatar-2.jpg'); ?>" class="me-3 rounded-circle avatar-xs flex-shrink-0" alt="user-pic">
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                          ...
                          <?php echo ucfirst(session()->get('username')); ?>
                            <!-- <span class="text-start ms-xl-2">
                               <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Gloria </span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo ucfirst(session()->get('username')); ?></span>
                            </span> -->
                        </span>
                    </button>
